...
INSTALLATION
Delete the existing Modules/GuidedArrow folder, then copy this GuidedArrow folder into Bannerlord/Modules.
...
GUIDED RELEASE
Level 1 unlocks manual guidance with a real four-second cap. Higher Guided Release and Master of the Curve levels extend or eventually release the cap.
