...
namespace GuidedArrow.Progression
{
    ...
    ///
    /// The verified core retains only 32 pending collision contexts and 32 early native reactions.
    /// A larger same-tick volley can therefore discard live correlation state before Bannerlord
    /// delivers every collision reaction. The same impact path can also re-sample native victim
    /// health and skeleton state for every arrow striking one already-tracked victim.
    /// </summary>
