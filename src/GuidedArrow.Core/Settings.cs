...
public sealed class Settings : AttributeGlobalSettings<Settings>
{
	...
	[SettingPropertyGroup("General", GroupOrder = 0)]
	[SettingPropertyFloatingInteger("High-Speed Steering Strength", 0f, 2f, "0.00", Order = 4, RequireRestart = false, HintText = "Extra steering authority for missiles faster than Reference Mission.Missile Speed. 0 = disabled, 1 = linear boost with speed ratio, 2 = stronger squared boost.")]
	...
	[SettingPropertyGroup("Proximity Time Dilation", GroupOrder = 1)]
	[SettingPropertyFloatingInteger("Reference Mission.Missile Speed", 10f, 250f, "0", Order = 12, RequireRestart = false, HintText = "Mission.Missile speed in metres/second that preserves the original distance-only slowdown curve. Faster live missiles receive additional but capped slowdown near targets. Default 70 m/s keeps ordinary arrows close to v1.0.10 behavior.")]
